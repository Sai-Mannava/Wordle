...
class KeyboardCell: UICollectionViewCell {
  ...
  func configure(with string: String,  didSelectString: ((String) -> Void)?) {
    ...
    /* Exercise 2:
      ...
      Checkpoint: After finishing this exercise, you should now be able to see the keyb oard laid out on the screen! If it's not working, check your work on exercises 1 & 2.
    */
    // START YOUR CODE HERE
      self.string = string
      label.text = string
      self.didSelectString = didSelectString
